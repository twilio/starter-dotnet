...
<body>
    ...
    <div id="Div1">
        ...
        <div id="welcome">
            <img src="@Url.Content("~/Content/dotnet_shield256.png")" alt=".NET Shield"/>
    ...
    <div id="footer">
        <span>Twilio</span><img src="@Url.Content("~/Content/TwilioQuest32.png")" alt="TwilioQuest"/>Quest
        <p>
            Made with <img src="@Url.Content("~/Content/heart.gif")" alt="heart"> by your pals 
            <a href="http://www.twilio.com">@@twilio</a>.
        </p>
    </div>

    <!-- Some dirty JavaScript to help drive our UI -->
    <script src="@Url.Content("~/Content/js/ui.js")"></script>
    <!-- Some ajax magic to hit our back end and make calls/send messages -->
    <script src="@Url.Content("~/Content/js/form.js")"></script>
</body>
</html>