...
<body>
    ...
    <div id="content">
        ...
        <div id="welcome">
            <img id="Img1" runat="server" src="~/Content/dotnet_shield256.png" alt=".NET Shield"/>
    ...
    <div id="footer">
        <span>Twilio</span><img id="Img2" runat="server" src="~/Content/TwilioQuest32.png" alt="TwilioQuest"/>Quest
        <p>
            Made with <img id="Img3" runat="server" src="~/Content/heart.gif" alt="heart"> by your pals 
